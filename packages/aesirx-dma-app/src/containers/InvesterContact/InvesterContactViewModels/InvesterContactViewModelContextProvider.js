...
export const InvesterContactViewModelContextProvider = ({ children, viewModel }) => {
  return (
...
export const useInvesterContactViewModel = () => React.useContext(InvesterContactViewModelContext);
