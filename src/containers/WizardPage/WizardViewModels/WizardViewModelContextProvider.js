...
export const WizardViewModelContextProvider = ({ children, viewModel }) => {
  return (
    <WizardViewModelContext.Provider value={viewModel}>{children}</WizardViewModelContext.Provider>
  );
};

/* Hook to use store in any functional component */
export const useWizardViewModel = () => React.useContext(WizardViewModelContext);
