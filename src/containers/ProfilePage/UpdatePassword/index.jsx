              ...
              <div className="row">
                <div className="col-4">
                  <label className="form-label mb-3" htmlFor="curr_password">
                    <span className="text-blue-0">Current password</span>
                  </label>
                  <input
                    type="password"
                ...
                <div className="col-4">
                  <label className="form-label mb-3" htmlFor="new_password">
                    <span className="text-blue-0">New Password</span>
                  </label>
                  <input
                    type="password"
                    className="form-control mb-3"
                ...
                <div className="col-4">
                  <label className="form-label mb-3" htmlFor="new_password">
                    <span className="text-blue-0 text-nowrap">Confirm New Password</span>
                  </label>
                  <input
                    type="password"
                    className="form-control mb-3"
